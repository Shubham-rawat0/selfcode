import { TextareaRenderable,ScrollBoxRenderable, type KeyBinding, TextAttributes, ScrollBox } from "@opentui/core"
...
function FileMentionMenu({candidates,selectedIndex,scrollRef,onExecute,onSelect}:FileMentionMenuProps){
