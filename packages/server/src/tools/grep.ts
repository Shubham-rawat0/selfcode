...
export function createGrepTool(cwd:string){
    return tool({
        description : 
        "Search files content using a regex pattern. Returns matching lines with file paths and line numbers. Skips hidden directories, node_modules and binary files",
        inputSchema:z.object({
            pattern:z.string().describe("Regex pattern tosearch for"),
            path:z.string()
